...
class InverseOESFilter(private val context: Context,private val render: VoidRender) : GPUFilter {
    ...
    override fun onSurfaceCreated() {
        ...
        val fragmentShader = compileShader(context.assets,gl.GL_FRAGMENT_SHADER, "shader/grain_fragOES.glsl")
        ...
        resHandle = gl.glGetUniformLocation(program, "iResolution")
        timeHandle = gl.glGetUniformLocation(program, "iTime")
    ...
    override fun onDraw(textureID: Int) {
        ...
        gl.glUniform2f(resHandle, render.cameraWidth.toFloat(), render.cameraHeight.toFloat())
