...
class DefaultOESFilter(private val context: Context) : GPUFilter {
    ...
    override fun onSurfaceCreated() {
        ...
        val fragmentShader = compileShader(context.assets,gl.GL_FRAGMENT_SHADER, "shader/main_fragOES.glsl")
    ...
    override fun onDraw(textureID: Int) {
        ...
        gl.glBindTexture(VoidRender.GL_TEXTURE_EXTERNAL_OES, textureID)
