...
class BulgeFilter(private val context: Context) : GPUFilter {
    ...
    override fun onSurfaceCreated() {
        ...
        val fragmentShader = compileShader(context.assets,gl.GL_FRAGMENT_SHADER, "shader/buldge_frag.glsl")
        ...
        // Fetch Bulge Uniforms
        centerHandle = gl.glGetUniformLocation(program, "center")
        radiusHandle = gl.glGetUniformLocation(program, "radius")
        scaleHandle = gl.glGetUniformLocation(program, "scale")
    ...
    fun setPosBulge(x: Float, y: Float){
        this.x = x
        this.y = y
    }
